...
<aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
    ...
    <ul class="menu-inner py-1">
        <li class="menu-item <?php if ($currentPage == 'dashboard_pegawai.php') echo 'active'; ?>">
            <a href="dashboard_pegawai.php" class="menu-link">
                <i class="menu-icon tf-icons bx bx-home-alt"></i>
                <div class="text-truncate">Dashboards</div>
            </a>
        </li>

        <li class="menu-item <?php if ($currentPage == 'dokumen_anda.php') echo 'active'; ?>">
            <a href="dokumen_anda.php" class="menu-link">
                <i class="menu-icon tf-icons bx bx-upload"></i>
                <div class="text-truncate">Upload Dokumen</div>
            </a>
        </li>
