...
$query = "SELECT dokumen.*, users.nama AS nama_user 
          ...
          WHERE dokumen.bidang = 'TL Pemeliharaan Prediktif' 
          LIMIT $start, $perPage";
$result = mysqli_query($conn, $query);

$totalQuery = "SELECT COUNT(*) AS total 
               FROM dokumen 
               WHERE bidang = 'TL Pemeliharaan Prediktif'";
...
<head>
    ...
    <title>Data TL Pemeliharaan Prediktif</title>
                                ...
                                <div class="card">
                                    ...
                                    <div class="col-xxl">
                                        <div class="card-header d-flex align-items-center justify-content-between">
                                            <h5 class="mb-0">Dokumen TL Pemeliharaan Prediktif</h5>
                                        </div>
                                        <div class="card-body">
